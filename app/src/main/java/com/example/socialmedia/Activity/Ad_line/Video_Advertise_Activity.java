...
public class Video_Advertise_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_video_advertise);

        RelativeLayout viewads = findViewById(R.id.viewads);
        viewads.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Video_Advertise_Activity.this, View_ADs_Activity.class);
